...
BASE_MODULE_NAME = "surmod_v8_test_base_for_v10"
...
def configure_v10_test(base: ModuleType) -> None:
    cfg = base.Config
...
def main() -> None:
    ...
    configure_v10_test(base)

    print("\n" + "=" * 60)
    print("2D-CNN Multimodal Model Testing Script v10 (Floors 3 to 7)")
    print("=" * 60 + "\n")
