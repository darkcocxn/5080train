...
class Config:
    ...
    MODEL_ROOT_DIR = PROJECT_ROOT / "output" / "2dcnnv5"
    ...
    VAL_LOW_DRIFT_RELATIVE_EPS = 0.00035
    VAL_FOCUS_LOW_MAE_WEIGHT = 0.22
    VAL_FOCUS_LOW_NORM_MAE_WEIGHT = 0.18
    ...
    SELECTION_LOW_DRIFT_MAE_WEIGHT = 0.14
    SELECTION_LOW_DRIFT_NORM_WEIGHT = 0.12
    ...
    metadata.update(
        {
            ...
            "architecture_revision": "v5_tail_preserved_low_drift_accuracy",
            "best_weights_name": "best_2dcnn_model.pth",
    ...
    for epoch in range(Config.NUM_EPOCHS):
        ...
        if Config.SAVE_ALTERNATE_BEST_CHECKPOINTS:
            ...
            if focus_metrics["low_drift_norm_mae"] < best_low_drift_checkpoint:
                ...
                torch.save(checkpoint_state, Config.SAVE_DIR / "best_2dcnn_low_drift_model.pth")
